...
class ExpirationForm(QDialog):
    ...
    def setup_notes_tab(self, tab):
        ...
        notes_label = QLabel("Notas y observaciones:")
        ...
        if self.expiration_id:
            ...
            # Parsear historial desde las notas (si es posible)
            if self.expiration_data and self.expiration_data.get('notes'):
                self.parse_history_from_notes()
